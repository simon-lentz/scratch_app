...
final class $$ChecklistsTableReferences
  ...
  static MultiTypedResultKey<$TasksTable, List<Task>> _tasksRefsTable(
    ...
    db.tasks,
    aliasName: 'checklists__id__tasks__checklist_id',
  );
                  ...
                  if (tasksRefs)
                    ...
                    >(
                      ...
                      managerFromTypedResult: (p0) =>
                          $$ChecklistsTableReferences(db, table, p0).tasksRefs,
...
final class $$TasksTableReferences
  ...
  static $ChecklistsTable _checklistIdTable(_$AppDatabase db) =>
      db.checklists.createAlias('tasks__checklist_id__checklists__id');
...
class $$TasksTableTableManager
    extends
        RootTableManager<
          ...
          Task,
          PrefetchHooks Function({bool checklistId, bool subtasksRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({checklistId = false, subtasksRefs = false}) {
            return PrefetchHooks(
              db: db,
