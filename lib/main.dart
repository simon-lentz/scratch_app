...
class ScratchApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const ScratchHomePage(title: 'Scratch App Home Page'),
    );
  }
}
...
class ScratchHomePage extends StatefulWidget {
  ...
  @override
  State<ScratchHomePage> createState() => _ScratchHomePageState();
}

class _ScratchHomePageState extends State<ScratchHomePage> {
  int _counter = 0;
